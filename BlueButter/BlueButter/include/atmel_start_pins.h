 ...
 * \param[in] pull_mode Pin pull mode
 */
static inline void PWR_Cntrl_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTA_set_pin_pull_mode(7, pull_mode);
}

/**
 * \brief Set PWR_Cntrl data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void PWR_Cntrl_set_dir(const enum port_dir dir)
{
	PORTA_set_pin_dir(7, dir);
}

/**
 * \brief Set PWR_Cntrl input/sense configuration
 *
 * Enable/disable PWR_Cntrl digital input buffer and pin change interrupt,
 * select pin interrupt edge/level sensing mode
 *
 * \param[in] isc PORT_ISC_INTDISABLE_gc    = Iterrupt disabled but input buffer enabled
 *                PORT_ISC_BOTHEDGES_gc     = Sense Both Edges
 ...
 *                PORT_ISC_LEVEL_gc         = Sense low Level
 */
static inline void PWR_Cntrl_set_isc(const PORT_ISC_t isc)
{
	PORTA_pin_set_isc(7, isc);
}

/**
 * \brief Set PWR_Cntrl inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on PWR_Cntrl is inverted
 *                     false = I/O on PWR_Cntrl is not inverted
 */
static inline void PWR_Cntrl_set_inverted(const bool inverted)
{
	PORTA_pin_set_inverted(7, inverted);
}

/**
 * \brief Set PWR_Cntrl level
 *
 * Sets output level on a pin
 *
 * \param[in] level true  = Pin level set to "high" state
 *                  false = Pin level set to "low" state
 */
static inline void PWR_Cntrl_set_level(const bool level)
{
	PORTA_set_pin_level(7, level);
}

/**
 * \brief Toggle output level on PWR_Cntrl
 *
 * Toggle the pin level
 */
static inline void PWR_Cntrl_toggle_level()
{
	PORTA_toggle_pin_level(7);
}

/**
 * \brief Get level on PWR_Cntrl
 *
 * Reads the level on a pin
 */
static inline bool PWR_Cntrl_get_level()
{
	return PORTA_get_pin_level(7);
}

/**
 * \brief Set VDD_sense pull mode
 *
 * Configure pin to pull up, down or disable pull mode, supported pull
 * modes are defined by device used
 *
 * \param[in] pull_mode Pin pull mode
 */
static inline void VDD_sense_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTB_set_pin_pull_mode(0, pull_mode);
}

/**
 * \brief Set VDD_sense data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void VDD_sense_set_dir(const enum port_dir dir)
{
	PORTB_set_pin_dir(0, dir);
}

/**
 * \brief Set VDD_sense input/sense configuration
 *
 * Enable/disable VDD_sense digital input buffer and pin change interrupt,
 * select pin interrupt edge/level sensing mode
 *
 * \param[in] isc PORT_ISC_INTDISABLE_gc    = Iterrupt disabled but input buffer enabled
 *                PORT_ISC_BOTHEDGES_gc     = Sense Both Edges
 ...
 *                PORT_ISC_LEVEL_gc         = Sense low Level
 */
static inline void VDD_sense_set_isc(const PORT_ISC_t isc)
{
	PORTB_pin_set_isc(0, isc);
}

/**
 * \brief Set VDD_sense inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on VDD_sense is inverted
 *                     false = I/O on VDD_sense is not inverted
 */
static inline void VDD_sense_set_inverted(const bool inverted)
{
	PORTB_pin_set_inverted(0, inverted);
}

/**
 * \brief Set VDD_sense level
 *
 * Sets output level on a pin
 *
 * \param[in] level true  = Pin level set to "high" state
 *                  false = Pin level set to "low" state
 */
static inline void VDD_sense_set_level(const bool level)
{
	PORTB_set_pin_level(0, level);
}

/**
 * \brief Toggle output level on VDD_sense
 *
 * Toggle the pin level
 */
static inline void VDD_sense_toggle_level()
{
	PORTB_toggle_pin_level(0);
}

/**
 * \brief Get level on VDD_sense
 *
 * Reads the level on a pin
 */
static inline bool VDD_sense_get_level()
{
